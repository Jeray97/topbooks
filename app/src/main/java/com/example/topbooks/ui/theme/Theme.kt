...
private val LightColorScheme = lightColorScheme(
    ...
    primaryContainer = LightThemeColors.ArcDarkBrown,
    onPrimaryContainer = Color(0xFFFFFFFF),
    inversePrimary = LightThemeColors.ArcDarkBrown,
    secondary = LightThemeColors.ArcMediumBrown,
    onSecondary = Color(0xFFFFFFFF),
    secondaryContainer = LightThemeColors.ArcMediumBrown,
    onSecondaryContainer = Color(0xFFFFFFFF),
    tertiary = LightThemeColors.JournalRomance,
    onTertiary = Color(0xFFFFFFFF),
    tertiaryContainer = LightThemeColors.JournalRomance,
    ...
    surfaceVariant = LightThemeColors.Background,
    onSurfaceVariant = LightThemeColors.TextPrimary,
    surfaceTint = LightThemeColors.ArcDarkBrown,
    inverseSurface = LightThemeColors.TextPrimary,
    inverseOnSurface = LightThemeColors.Background,
    error = Color(0xFFBA1A1A),
    onError = Color(0xFFFFFFFF),
    errorContainer = Color(0xFFFFDAD6),
    onErrorContainer = Color(0xFF410002),
    outline = LightThemeColors.ArcMediumBrown,
    outlineVariant = LightThemeColors.ArcMediumBrown.copy(alpha = 0.5f),
    surfaceBright = LightThemeColors.ComponentBackground,
    surfaceDim = LightThemeColors.Background,
    surfaceContainerLowest = LightThemeColors.Background,
    surfaceContainerLow = LightThemeColors.ComponentBackground,
    surfaceContainer = LightThemeColors.ComponentBackground,
    surfaceContainerHigh = LightThemeColors.ComponentBackground,
    surfaceContainerHighest = LightThemeColors.ComponentBackground
)
